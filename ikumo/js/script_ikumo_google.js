$(function () {
	...
	var allList = [

		{
			...
			life: 1.6,
			list_price: "1880円",
			price: "1,489円<br class=\"br-400px\">&nbsp;<br class=\"spbr\"><span>20%OFF!</span>",
			...
			nayami: "抜け毛",
			tag: [],
			description: "・ 元値が安いため、 定期3回購入しても4467円。 送料も0円。 気軽にお試しできる。<br>・ 成長段階（ 子猫、 シニアetc） や室内用、 体重ケア用など猫ちゃんによって適切なフードを選べる ",
			...
			reviews: "「風味が選べるのが気に入ってます」ピュリナワン・ キャットフードはラインナップがとても豊富なので、 さまざまな種類をローテーションさせて愛猫に与えています。 健康維持にもなるし、 風味も変わるため愛猫も喜んで食べてくれます。 "
		},
		{
			id: "id006",
			name: "ねこはぐ",
			...
			reviews: "原材料なんかをみてもわかるとおり、 ねこはぐは安心して与えらるし、 すごい食いつきます！価格帯でちょっと高めですけど、 安全で安心です。国産にこだわるなら、 値段は仕方ないなと思ってます。 "
		},
		{
			id: "id008",
			name: "モグニャン",
			...
			reviews: "賞味期限が、開封後約1カ月で、少し短いです。その代わり、 人口添加物不使用とあって、 安全で健康です。うちは子猫を飼っているのですが、 食いつきは間違いないです！ "
		},
		{
			id: "id005",
			name: "シンプリー",
			...
			nayami: "抜け毛",
			tag: [],
			description: "・定期で購入すると最大20％ OFF（ 解約可能）<br>・動物栄養学者と作った全猫種対応、 子猫からシニアまで食べれる健康フード<br>・ フード用スクーププレゼント ",
			link: "https://h.accesstrade.net/sp/cc?rk=0100kmzl00i1f6",
			reviews: "自然とうんちの状態がバナナくらいの良い硬さになってきたんです。開けた時の匂いにはびっくりしましたね、香料を使っているんじゃないかと思って調べてみたんですが無添加ということで安心しました。魚の割合が多いということでアイムスよりも良いフードみたいです。"
		},
		{
			id: "id003",
			name: "ジャガー",
			...
			nayami: "M字型",
			tag: [],
			description: "・とにかく品質重視、上質な肉と新鮮な果物を使用(ヒューマングレード）<br>・動物性たんぱく質80％ 以上のプレミア品<br>・ 安心のグレインフリー（ 穀物不使用） ",
			link: "https://h.accesstrade.net/sp/cc?rk=0100kn1e00i1f6",
			reviews: "今までのキャットフード史上、 最高の食いつきでした。うんちの匂いが消えました。うんちの色は黒くツヤツヤ、 よく見るとしっかり毛玉も排出できています。 "
		},

		{
			...
			reviews: "カナガンキャットフードにしてから、たまに起きていた皮膚炎にもならなくなり体調もいいです♪値段は以前あげていたキャットフードより高いですが、 病院通いよりはぜんぜん安上がり。 "
		},
		{
			id: "id001",
			name: "オリジンジャパン",
			...
			reviews: "とにかく栄養素が高いから、仔猫や成長期の猫にはおすすめカロリーが高め＋ かなりの高たんぱくなので、中年～ シニア猫にはちょっと消化が大変かもしれない "
		}
	];
